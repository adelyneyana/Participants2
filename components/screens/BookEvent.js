...
import { SafeAreaView, StyleSheet, View, Text, TextInput, TouchableOpacity, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          ...
          <View style={styles.formGroup}>
            <TouchableOpacity style={styles.calendarButton} onPress={toggleCalendar}>
              <Text style={styles.calendarButtonText}>Choose from calendar (EVENT DATE)</Text>
            </TouchableOpacity>
            {isCalendarVisible && (
          ...
          <View style={styles.formGroup}>
            <View style={styles.budgetContainer}>
              ...
              <View style={styles.budgetPrices}>
                <Text style={styles.budgetPrice}>{formatNumber(sliderValues[0])}</Text>
                <View style={styles.budgetArrowContainer}>
                  <Icon name="long-arrow-right" size={20} color="#fff" />
                </View>
                <Text style={styles.budgetPrice}>{formatNumber(sliderValues[1])}</Text>
              </View>
            </View>
            <Slider
              style={styles.slider}
              ...
              onValueChange={(value) => handleSliderValueChange([value, sliderValues[1]])}
            ...
            <Slider
              ...
              onValueChange={(value) => handleSliderValueChange([sliderValues[0], value])}
              thumbTintColor="#e6b800"
              minimumTrackTintColor="#e6b800"
              maximumTrackTintColor="#777"
            />
